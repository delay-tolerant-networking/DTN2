 ...
 */
typedef enum {
    EHS_BPA_RECEIVED = 0x1,     ///< BPA message received from DTN2 ExternalRouter
...
public:
     ...
     * Constructor
     */
    EhsBpaReceivedEvent(std::auto_ptr<rtrmessage::bpa> bpa_ptr)
    ...
    std::auto_ptr<rtrmessage::bpa> bpa_ptr_;
};
