...
public:
    ...
    /**
     * Pass through a message to the EhsExernalRouter to be sent to the DTN2 node
     */
    virtual void send(rtrmessage::bpa& msg);

    /**
     * Issue shutdown request to the DTN2 server
     */
