 ...
 */
class Ciphersuite /*  : public BlockProcessor */ {
...
//                        u_char* buf, size_t len) = 0;
    ...
    virtual bool validate(const Bundle* bundle, BlockInfoVec*  block_list, BlockInfo* block,
                     ...
                     BundleProtocol::status_report_reason_t* deletion_reason) = 0 ;
     ...
     */
    static bool source_is_local_node(const Bundle* bundle, const BlockInfo* block);
    static bool destination_is_local_node(const Bundle* bundle, const BlockInfo* block);
