...
public:
     ...
     */
    void ProcessSessionEvent(MySendObject * event);
    ...
    public:
         ...
         */
        void ProcessReceiverSessionEvent(MySendObject * event);
        ...
        void ProcessSegmentEvent(string segment_key,DS_MAP * segments, void* timer);
        void ProcessSegmentEvent(string segment_key,RS_MAP * segments, void* timer);
    ...
    protected:
        ...
        protected:
            ...
            oasys::SpinLock bytes_queued_lock_;
        ...
        void generate_RS(LTPUDPSession * report_session, int segment_type);
...
//dz        void generate_RS_ack(LTPUDPSession * report_session);
        ...
        void Handle_Event(MySendObject * event);
        void ProcessSenderSessionEvent(MySendObject * event);
        void ProcessSegmentEvent(string segment_key,DS_MAP * segments, void* timer);
        void ProcessSegmentEvent(string segment_key,RS_MAP * segments, void* timer);
    ...
    private:
         ...
         */
        int process_bundles(LTPUDPSession* loaded_session, bool is_green);
        /**
