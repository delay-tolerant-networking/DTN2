...
public:
    ...
    void Cleanup_Session_Receiver(string session_key,int force); 
...
protected:
    ...
    private:
        ...
        friend class LTPUDPReplayConvergenceLayer;
         ...
         */
        u_char buf_[LTPUDPReplayConvergenceLayer::MAX_BUNDLE_LEN];
